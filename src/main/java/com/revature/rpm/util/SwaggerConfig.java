...
/**
 * The SwaggerConfig is used to show information about the auth-service. Information includes
 * swagger version, basic information, host, base path, tags, what the API consumes and produces,
 * end points, and model definitions.
 */
@Configuration
@EnableSwagger2
